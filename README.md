...
Here I make a script which will make the same task but here I make it as a application program which start doing the things after reboot my linux system. --> (This is a different process we will discuss later)
This script ask the owner of the system that you want to update it now or you want to postpond the procedure for now...
